...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/alugacar/views/css/style.css">
    <script src="http://localhost/alugacar/views/js/index.js" defer></script>
    
    <link rel="shortcut icon" href="http://localhost/alugacar/storage/imgs/<?php echo $_ENV['logo']; ?>" type="image/x-icon">
    <title>Checkout | <?php echo $_ENV['nome_site']; ?></title>
</head>
<body>
