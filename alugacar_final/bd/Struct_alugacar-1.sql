...
(1,'Arligreicy Castro Silva','F','1991-11-20','XX.XXX.XXX/XXXX-X1','arligreicy@gmail.com','$2y$10$djtr.z1wBlEBtMpEip3u1ulPa7S3JeQPG6rh5qbsKYX9eAPFHtrQW'),
(2,'Zack Castro','M','2014-08-08','XX.XXX.XXX/XXXX-X2','zack@gmail.com','$2y$10$djtr.z1wBlEBtMpEip3u1ulPa7S3JeQPG6rh5qbsKYX9eAPFHtrQW');
...
insert  into `carro`(`id_carro`,`descritivo`,`marca`,`modelo`,`img`,`preco_dia`) values 
(1,'carro de passeio','Volkswagen','Gol','sedan.jpg',50.00),
(2,'carro de passeio','Hundai','HB20','suv.jpg',50.00),
(3,'carro de passeio','Chevrolet','Onix','compacto.png',50.00),
(4,'carro de passeio','Fiat','Mobi','sedan.jpg',50.00),
(5,'carro de viagem','Volkswagen','Gol','suv.jpg',50.00),
(6,'carro de viagem','Hundai','HB20','compacto.png',50.00),
(7,'carro de viagem','Chevrolet','Onix','sedan.jpg',50.00),
(8,'carro de viagem','Fiat','Mobi','suv.jpg',50.00),
(9,'carro para um dia','Volkswagen','Gol','compacto.png',50.00),
(10,'carro para um dia','Hundai','HB20','sedan.jpg',50.00),
(11,'carro para um dia','Chevrolet','Onix','suv.jpg',50.00),
(12,'carro para um dia','Fiat','Mobi','compacto.png',50.00);
...
CREATE TABLE `locacao` (
  ...
  `valor_locacao` decimal(8,2) NOT NULL,
  ...
  CONSTRAINT `locacao_ibfk_3` FOREIGN KEY (`id_carro`) REFERENCES `carro` (`id_carro`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `locacao` */

insert  into `locacao`(`id_locacao`,`data_locacao`,`status_locacao`,`id_fp`,`id_cliente`,`id_carro`,`quantidade`,`valor_locacao`) values 
(1,'2024-06-01','disponivel',2,1,1,1,250.0),
(2,'2024-06-05','indisponivel',2,1,2,1,250.0);
